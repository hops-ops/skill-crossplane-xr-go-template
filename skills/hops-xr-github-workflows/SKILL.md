---
name: xr-github-workflows
description: |
  GitHub Actions workflow templates for XRD configurations: on-pr, on-push-main,
  OIDC authentication, E2E job configuration, and example synchronization.
---
