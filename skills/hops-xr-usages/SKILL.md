...
name: hops-xr-usages
description: |
  Usage resources for deletion protection, naming conventions, placement rules,
  readiness gating, deterministic naming for dynamic lists, and compositeDeletePolicy.
---
