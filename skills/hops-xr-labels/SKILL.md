...
name: hops-xr-labels
description: |
  Labels and tags pattern for XRDs: default label/tag values, XRD schema definition,
  state-init computation, applying to Kubernetes and AWS resources, and collection-specific patterns.
---
