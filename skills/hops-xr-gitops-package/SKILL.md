---
name: xr-gitops-package
description: |
  GitOps deployment package structure (.gitops/deploy/), Helm chart for configuration deployment,
  default vs platform deployment modes, and skipDependencyResolution.
---
